...
async def play(_, message: Message):
    ...
    try:
        ...
        await lel.edit(
            f"<i>𝗔𝘀𝘀𝗶𝘀𝘁𝗮𝗻𝘁 𝗨𝘀𝗲𝗿𝗕𝗼𝘁 𝗜𝘀 𝗡𝗼𝘁 𝗜𝗻 𝗧𝗵𝗶𝘀 𝗖𝗵𝗮𝘁' 𝗔𝘀𝗸 𝗔𝗱𝗺𝗶𝗻 𝗧𝗼 𝗦𝗲𝗻𝗱 /𝗽𝗹𝗮𝘆 𝗖𝗼𝗺𝗺𝗮𝗻𝗱 𝗙𝗼𝗿 𝗙𝗶𝗿𝘀𝘁 𝗧𝗶𝗺𝗲 𝗧𝗼 𝗔𝗱𝗱 𝗜𝘁 😎🤟</i>"
        )
        return
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/8f4cd50b70214b75212a0.jpg"
            ...
            [
                [
                    InlineKeyboardButton(
                        text="𝗖𝗵𝗮𝗻𝗻𝗲𝗹", url=f"https://t.me/DEXDECRYPT"
                    ),
                    InlineKeyboardButton(text="𝗚𝗿𝗼𝘂𝗽", url=f"https://t.me/dost_hai_sab"),
                ]
            ]
        )
            ...
            keyboard = InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton(
                            text="𝗚𝗿𝗼𝘂𝗽", url=f"https://t.me/dost_hai_sab"
                        ),
                    ]
                ]
            )
